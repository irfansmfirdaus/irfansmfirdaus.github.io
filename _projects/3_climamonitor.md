...
<div class="row justify-content-sm-center">
  <div class="col-sm-8 mt-3 mt-md-0">
    {% include figure.liquid path=site.data.update_climamonitor.change_image title="Temperature Change" class="img-fluid rounded z-depth-1" %}
  </div>
  <div class="col-sm-4 mt-3 mt-md-0">
    {% include figure.liquid path=site.data.update_climamonitor.capital_image title="Change Capital Temperature" class="img-fluid rounded z-depth-1" %}
  </div>
</div>